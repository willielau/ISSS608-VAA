...
```{r}
ggplot() +
  geom_bar(Mtop9data, mapping = aes(x = Pop, y = AG, fill = Sex), width = 0.8, stat = "identity") +
  geom_bar(Ftop9data, mapping = aes(x = Pop, y = AG, fill = Sex), width = 0.8, stat = "identity") +
  facet_wrap (~ PA)
```
